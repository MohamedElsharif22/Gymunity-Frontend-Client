...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-sky-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-12">
          <div class="flex items-center justify-between mb-4">
            ...
            <a routerLink="/discover-programs" class="hidden md:flex items-center gap-2 bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-600 hover:to-indigo-700 text-white font-semibold py-3 px-6 rounded-lg transition shadow-lg">
        ...
        @if (isLoading()) {
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @for (program of activePrograms(); track program.id) {
              <div class="group border border-gray-200 hover:border-sky-300 rounded-2xl overflow-hidden hover:shadow-2xl transition-all transform hover:-translate-y-2 cursor-pointer bg-white" 
                ...
                @if (program.thumbnailUrl) {
                  ...
                  <div class="h-56 bg-gradient-to-br from-sky-400 to-indigo-600 flex items-center justify-center relative overflow-hidden">
                ...
                <div class="p-6">
                  ...
                  <!-- View Button -->
                  <button class="w-full bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-600 hover:to-indigo-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group-hover:scale-105">
          ...
          <div class="text-center py-24">
            ...
            <a routerLink="/discover-programs" 
               class="inline-flex items-center gap-2 bg-gradient-to-r from-sky-500 to-indigo-600 hover:from-sky-600 hover:to-indigo-700 text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg hover:shadow-xl">
              Browse Programs
